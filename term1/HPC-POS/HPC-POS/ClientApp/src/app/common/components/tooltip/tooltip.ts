...
import { Dir } from "../../base/core/rtl/dir";
import { Platform } from "../../base/core/platform/index";
import "rxjs/add/operator/first";
import { ScrollDispatcher } from "../../base/core/overlay/scroll/scroll-dispatcher";
import { Subscription } from "rxjs/Subscription";
import { coerceBooleanProperty } from "../../base/core/coercion/boolean-property";
...
export class Md2Tooltip implements OnInit, OnDestroy {
  ...
  constructor(private _overlay: Overlay,
    ...
    _renderer.listen(_elementRef.nativeElement, "focus", () => this.show());
    _renderer.listen(_elementRef.nativeElement, "blur", () => this.hide());
  }
  ...
  show(delay: number = this.showDelay): void {
    ...
    this._setTooltipMessage(this._message);
    this._tooltipInstance.show(this._position, delay, this._class);
  }
  ...
  private _setTooltipMessage(message: string) {
    ...
    if (message == undefined
        || message == "") {
      this._tooltipInstance.hide(this.hideDelay);
    }
...
export class Md2TooltipComponent {
   ...
   */
  show(position: TooltipPosition, delay: number, css: any): void {
