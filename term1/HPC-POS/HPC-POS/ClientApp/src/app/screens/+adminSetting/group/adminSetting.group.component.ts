...
import "style-loader!./adminSetting.group.component.scss";

@Component({
  selector: "adminSetting-group",
  templateUrl: "./adminSetting.group.component.html"  
})
export class AdminSettingGroupComponent extends ABaseComponent {
