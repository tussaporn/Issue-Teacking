...
import "style-loader!./adminSetting.permission.component.scss";

@Component({
  selector: "adminSetting-permission",
  templateUrl: "./adminSetting.permission.component.html"  
})
export class AdminSettingPermissionComponent extends ABaseComponent {
