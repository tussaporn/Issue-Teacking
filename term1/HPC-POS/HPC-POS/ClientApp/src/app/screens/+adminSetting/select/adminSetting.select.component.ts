...
import "style-loader!./adminSetting.select.component.scss";

@Component({
  selector: "adminSetting-select",
  templateUrl: "./adminSetting.select.component.html"  
})
export class AdminSettingSelectComponent extends ABaseComponent {
